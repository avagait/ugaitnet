...
parser.add_argument('--videodir', type=str, required=False,
                    default='PATH/TUM_GAID/depthVideo/',
					help='Full path to depth video directory')
...
file_patterns, folders, gaits, set, ids, im_width, im_height, subject_pattern = getPartitions(dataset, mode, 'depth', n_frames, ids_file_path)
